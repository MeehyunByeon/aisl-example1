package aisl.example1.config;

import aisl.example1.security.JwtAuthenticationFilter;
        ...
        http
                ...
                .authorizeHttpRequests(authorize ->
                        authorize
                                ...
                                // /admin 요청은 ADMIN 권한이 있는 유저에게만 허용
                                .requestMatchers("/admin/**").hasRole("ADMIN")
                                // /user 요청은 USER 권한이 있는 유저에게만 허용
