package aisl.example1.security;

import aisl.example1.domain.Authority;
import aisl.example1.service.JpaUserDetailsService;
...
public class JwtProvider {
   ...
   @Value("${jwt.secret.key}")
    ...
    public String getAccount(String token) {
        // 만료된 토큰에 대해 parseClaimsJwd를 수행하면 io.jsonwebtoken.ExpiredJwrException이 발생한다.
        try {
